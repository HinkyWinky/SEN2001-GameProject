...
namespace Game
{
    public class GameManager : MonoBehaviour
    {
        ...
        [BoxGroup("Editor Mode"), SerializeField] private bool editorModeOn = false;
        [BoxGroup("Editor Mode"), SerializeField, ShowIf("editorModeOn"), Min(1)] private int startingLevelNoForEditorMode = 1;
        ...
        {
            if (EditorModeOn)
                StartCoroutine(SceneCtrl.LoadLevelScene(startingLevelNoForEditorMode, false)); // Load the Level1 scene at the start of the game.
            else
